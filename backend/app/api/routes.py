...
async def verify_carrier(request: CarrierVerificationRequest, req: Request):
...
async def search_loads(request: LoadSearchRequest, req: Request):
...
@limiter.limit("30/minute")
async def negotiate(request: NegotiationRequest, req: Request):
...
async def transfer_call(req: Request, call_id: str, carrier_name: Optional[str] = None):
...
@limiter.limit("60/minute")
async def log_call(call: CallLog, req: Request):
...
@limiter.limit("120/minute")
async def get_recent_calls(req: Request, limit: int = 20):
...
@router.get("/loads")
@limiter.limit("120/minute")
async def get_all_loads(req: Request):
    """List all loads."""
